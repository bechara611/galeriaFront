...
const FormularioRegister = ({estadoAlerta,cambiarEstadoAlerta,cambiarTipoMensaje,cambiarRegister}) => {
    ...
    return ( 
        ...
        <input type="email" placeholder="EMAIL" className='col-12 mb-2 form-control je control-imput' value={email} required onChange={(e)=>{
            cambiarEmail(e.target.value);
        }} />
        <input type="password" placeholder="PASSWORD" className='col-12 form-control mb-1 control-imput' value={password1}  required onChange={(e)=>{
            cambiarPassword1(e.target.value)
        }}/>
        <input type="password" placeholder="REPEAT PASSWORD" className='col-12 form-control control-imput' value={password2} required onChange={(e)=>{
