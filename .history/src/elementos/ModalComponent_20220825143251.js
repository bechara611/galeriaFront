        ...
        <div className="modal" id={"Modal-"+index} tabIndex={-1} aria-hidden="true" aria-labelledby="label-modal-1">
            <div className="modal-dialog modal-lg text-center">
                <div className="modal-content text-center">
                  ...
                  <a href={elemento.img} download="image.jpg" target={blank} className='btn btn-success btn-sm'>Open</a>
                  <a href="/path/to/image" download="myimage"><img src={elemento.img}  alt=''/>Download2</a>
                  </>
                    }
