...
const FormularioLogin = () => {
    return ( 
        ...
        <input type="password" placeholder="PASSWORD" className='col-12 form-control' />
         ...
         <Boton fondoVerde className="col-8 mt-2">LOGIN</Boton>
         <Boton fondoAzul className="col-8 mt-2">REGISTER</Boton>
         </div>
         <div className="centrar2 mt-2 col-12">
        <Boton className='col-6 recovery' fondoBlanco >Recovery password</Boton>
         </div>
