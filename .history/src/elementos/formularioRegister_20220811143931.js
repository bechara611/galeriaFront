...
import { postRegistrarUsuario, postRegistrarUsuario2 } from "../helpers/peticiones";
    ...
    useEffect(()=>{
        async function metodo(){
            if(fetchRegistrar===true){
                const resultado = await postRegistrarUsuario2(nombre.toUpperCase(),email.toLowerCase(),password1)
